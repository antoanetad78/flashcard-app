const data = {
    ...
    cityscapes: [{
        ...
        {
            picture: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/High_buildings_in_Amsterdam.jpg/250px-High_buildings_in_Amsterdam.jpg',
            word: 'Gebouwen'
        },
        {
            picture: "https://erfgoedstem.nl/wp-content/uploads/2014/09/Overzicht_Olympisch_Stadion_-_Amsterdam_-_20409334_-_RCE.jpg",
            word: "Olympisch stadion"
        },
        {
            picture: "https://www.gemeente.nu/content/uploads/2016/12/vervoergracht.jpg",
            word: "Gracht"
        }
    ],
    food: [{
            picture: 'https://www.dovesfarm.co.uk/uploads/images/presets/product_page_full/recipes/Freee%20Bread/Freee_BrownBread.jpg',
            word: 'Brood'
        },
        {
        ...
        {
            picture: "https://www.jmouders.nl/wp-content/uploads/2018/06/9x_stamppot_met_boerenkool_jmouders.nl_-1.jpg",
            word: "Boerenkool"
        }
    ],
    furniture: [{
...
let currentCategory = dropdown.options[dropdown.selectedIndex].value;
let currentArray = data[currentCategory]

function getRandomNumber() {
    const number = Math.floor(Math.random() * currentArray.length)
    return number;
}
...
function createFlashcard(mode) {
    ...
    if (mode === 'picture') {
        ...
        img.src = data[currentCategory][number].picture;
        img.setAttribute('class', 'visible')
        flashcard.appendChild(img);
        const word = document.createElement('span');
        word.innerText = data[currentCategory][number].word
...
function changeCategory() {
    currentCategory = document.getElementById("categories").options[dropdown.selectedIndex].value;
    console.log(currentCategory)
}